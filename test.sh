...
node tests/schema.test.js schemas/navigation.schema.json src/_data/navigation.json
node tests/schema.test.js schemas/service-info-list.schema.json src/_data/service-info-list.json
